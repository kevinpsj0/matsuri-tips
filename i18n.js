...
var I18N = {
  en: {
    ...
    settings_language_hint: "Applies to this device only (entry app and admin).",
    settings_show_split: "Show tip split after submission",
    settings_show_split_hint: "When off, servers see only a confirmation, not the per-person breakdown. Applies to everyone.",
    saving: "Saving...",
    saved: "Saved",
  ...
  ko: {
    ...
    split_hidden_ready: "입력이 완료되었습니다. 제출을 눌러 기록하세요.",
    submit: "제출",
    submitting: "제출 중...",
    ph_name: "이름",
    remove: "삭제",
    ...
    server_n: "서버 {n}",
    server_word: "서버",
    both_entered: "오늘 점심과 저녁 근무가 모두 입력되었습니다. '오늘'에서 수정하세요.",
    one_entered: "오늘 {shift} 근무가 이미 입력되었습니다.",
    trainee_suffix: "({pct}% 수습)",
    prev_recorded: "이전에 기록된 근무",
    shift_recorded: "근무가 기록되었습니다",
    record_another: "다른 근무 입력",
    required: "필수",
    err_amount_range: "$1 ~ $100,000 사이 금액을 입력하세요",
    name_required: "이름을 입력하세요",
    pick_time_slot: "시간대를 선택하세요",
    dup_server: "중복된 서버 이름",
    err_save_conn: "저장하지 못했습니다. 연결을 확인하고 다시 제출하세요.",
    ...
    no_shifts_today: "아직 오늘 입력된 근무가 없습니다.",
    ...
    send_request: "요청 보내기",
    sending: "보내는 중...",
    edit_sub_tpl: "{date} {time} · {amount} 근무. 사장님이 검토합니다.",
    shift_gone: "해당 근무가 더 이상 목록에 없습니다. 새로고침하세요.",
    err_who_recorded: "근무를 입력한 사람을 적어주세요.",
    ...
    no_shifts_period: "이 기간에 근무가 없습니다.",
    shift_one: "근무",
    shift_many: "근무",
    range_sep: "~",
    card_total_tips: "총 팁",
    ...
    next_month: "다음 달",
    cal_back: "달력",
    no_shifts_day: "이 날에 근무가 없습니다.",
    req_by: "요청자",
    deny: "거부",
    approve: "승인",
    diff_current: "현재",
    diff_proposed: "제안",
    orig_not_found: "장부에서 원본 근무를 찾을 수 없습니다.",
    ...
    settings_language_hint: "이 기기에만 적용됩니다 (입력 앱과 관리자).",
    settings_show_split: "제출 후 팁 분배 표시",
    settings_show_split_hint: "끄면 서버는 개인별 내역 없이 확인 메시지만 봅니다. 모두에게 적용됩니다.",
    saving: "저장 중...",
    saved: "저장됨",
